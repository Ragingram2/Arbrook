...
namespace rythe::rendering
{
	...
	public:
		static texture_handle createTexture2D(const std::string& name, const std::string& filepath, texture_parameters params = { GL_REPEAT ,GL_REPEAT,GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR });
