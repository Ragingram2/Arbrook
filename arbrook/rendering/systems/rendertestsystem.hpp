...
#include "rendering/components/testrenderer.hpp"
...
namespace rythe::rendering
{
	...
	class RenderTestSystem : public core::System<core::transform, testrenderer>
	{
	public:
		RenderInterface* m_api;

		static std::vector<void(RenderTestSystem::*)()> m_testScenes;
		static int currentScene;

		RenderTestSystem() = default;
		virtual ~RenderTestSystem() = default;
