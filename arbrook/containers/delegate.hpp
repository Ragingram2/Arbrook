...
#include "containers/iterator_tricks.hpp"
...
#pragma region element access
        R_NODISCARD reference at(size_type index) { return m_invocationList.at(index); }
        R_NODISCARD const_reference at(size_type index) const { return m_invocationList.at(index); }

        R_NODISCARD reference operator[](size_type index) { return m_invocationList[index]; }
        R_NODISCARD const_reference operator[](size_type index) const { return m_invocationList[index]; }

        R_NODISCARD reference front() { return m_invocationList.front(); }
        R_NODISCARD const_reference front() const { return m_invocationList.front(); }

        R_NODISCARD reference back() { return m_invocationList.back(); }
        R_NODISCARD const_reference back() const { return m_invocationList.back(); }

        R_NODISCARD pointer data() { return m_invocationList.data(); }
        R_NODISCARD const_pointer data() const { return m_invocationList.data(); }
#pragma endregion

#pragma region iterators
        R_NODISCARD iterator begin() noexcept { return m_invocationList.begin(); }
        R_NODISCARD const_iterator begin() const noexcept { return m_invocationList.cbegin(); }
        R_NODISCARD const_iterator cbegin() const noexcept { return m_invocationList.cbegin(); }

        R_NODISCARD iterator end() noexcept { return m_invocationList.end(); }
        R_NODISCARD const_iterator end() const noexcept { return m_invocationList.cend(); }
        R_NODISCARD const_iterator cend() const noexcept { return m_invocationList.cend(); }

        R_NODISCARD reverse_iterator rbegin() noexcept { return m_invocationList.rbegin(); }
        R_NODISCARD const_reverse_iterator rbegin() const noexcept { return m_invocationList.crbegin(); }
        R_NODISCARD const_reverse_iterator crbegin() const noexcept { return m_invocationList.crbegin(); }

        R_NODISCARD reverse_iterator rend() noexcept { return m_invocationList.rend(); }
        R_NODISCARD const_reverse_iterator rend() const noexcept { return m_invocationList.crend(); }
        R_NODISCARD const_reverse_iterator crend() const noexcept { return m_invocationList.crend(); }
...
#pragma region capacity
        R_NODISCARD bool empty() const noexcept { return m_invocationList.empty(); }
        R_NODISCARD size_type size() const noexcept { return m_invocationList.size(); }
        R_NODISCARD size_type max_size() const noexcept { return m_invocationList.max_size(); }
        void reserve(size_type newSize) { m_invocationList.reserve(newSize); }
        R_NODISCARD size_type capacity() const noexcept { return m_invocationList.capacity(); }
