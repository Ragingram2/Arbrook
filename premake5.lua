...
-- function createCMAKEProject(groupName,projectName,command)
--     print("Building Cmake project " .. projectName)
--     group ("" .. groupName)
...
PROJECT_FILENAME = "arbrook_project"
...
local a = require("premake/arbrook")
